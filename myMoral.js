...
var questionsArr = [
	...
	"Omasta osaamisestaan valehteleminen on väärin, joten en huijaa.", "Huijaamalla saan opiskelupaikan, jonka olisin muutenkin ansainnut luettuani ahkerasti, siis huijaan.", "Koen velvollisuudekseni olla huijaamatta, sillä pääsykokeen järjestäjät toivovat rehellisyyttä.", "Pääsykokeen järjestäjät eivät ole evänneet minulta oikeutta huijata, joten huijaan.", "En huijaa, sillä uskon kokelasyhteisön yleisesti tuomitsevan huijaamisen myös näissä erityisolosuhteissa."],
	...
	"Ystäväsi suhde on tuomittu puolison epärehellisyyden takia, joten minun on parempi kertoa ystävälleni salasuhteesta.", "Jos kerron salasuhteesta ennen seremoniaa, koko häät ja ystävän suhde menevät pilalle, en siis kerro.", "Koen, että minun tulee hyvänä ystävänä olla rehellinen ystävälleni ja kertoa suhteesta.", "Ystäväni puolisolla on oikeus selittää salasuhteestaan itse minun puuttumatta asiaan, en kerro.", "Uskon, että ystäväni haluaisi monien muiden tavoin saada tietää salasuhteesta ajoissa, joten kerron."],
	...
	"Varastaminen on väärin kontekstista riippumatta, joten paljastan ystäväni rikoksen.", "Ystäväni teon vuoksi orpokodin lasten elinolosuhteet paranivat eivätkä miljardöörin elinolosuhteet juuri huonontuneet, joten en kantele ryöstöstä.", "Koen, että minun tulee lainkuuliaisena kansalaisena ilmoittaa viranomaisille laittomasta ryöstöstä.", "Miljardöörillä on oikeus omaisuutensa, joten paljastan tuttuni poliisille.", "En kerro ystävästäni poliisille, sillä uskon sanattomaan sopimukseen jonka mukaan köyhä orpokoti tarvitsee rahoja enemmän kuin miljardööri."],
	...
	"Lääkärinä minulle olisi liian suuri pahe jättää lääkitsemättä lääkettä tarvitseva kuudes potilas, joten lääkitsen hänet.", "Jätän kuudennen potilaan lääkitsemättä, sillä tällöin useampi potilas selviää hengissä ja lääkärityöni lopputulos on parempi.", "Olen lääkärinä velvoitettu hoitamaan jokaista potilastani parhaan mukaan tasaveroisesti, joten en voi jättää lääkitsemättä kuudennetta potilasta.", "Minulla ei ole oikeutta päättää kuudennen potilaan uhraamisesta viiden muun pelastamiseksi, joten lääkitsen kuudennen potilaan.", "Uskon, että yleisen mielipiteen mukaan on parempi pelastaa mahdollisimman monta ihmishenkeää, joten jätän kuudennen potilaan lääkitsemättä."],
